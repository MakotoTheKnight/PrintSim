...
public class Printer implements ClockEvent {
    ...
    protected int departureTick;
    protected int arrivalTick;
    protected int currentTick;
    protected int changeoverTick;
    protected int queue_ID;
    protected int idleCounter;
    protected int beginChangeTick;
    ...
    protected boolean setPrintJob;
    protected boolean hasBegun;
    protected boolean impatient;
    protected boolean settingInk;
    protected boolean settingPaper;
    protected boolean usingPriorityQueue;
    protected final int INK_CHANGEOVER = 10;
    protected final int PAPER_CHANGEOVER = 5;
    protected String paperColor;
    protected String inkColor;
    protected String output;
    protected ArrayList<String> oldConfig;
    protected ArrayList<String> newConfig;
    protected Queue currentQueue;
    protected Queue softQueue;
